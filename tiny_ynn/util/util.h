...
#include "tiny_ynn/xtensor/xarray.hpp"
#include "tiny_ynn/xtensor/xview.hpp"
...
#include "tiny_ynn/util/aligned_allocator.h"
#include "tiny_ynn/util/macro.h"
#include "tiny_ynn/util/nn_error.h"
#include "tiny_ynn/util/parallel_for.h"
...
inline std::string to_string(vector_type vtype) {
  switch (vtype) {
    case tiny_ynn::vector_type::data: return "data";
    case tiny_ynn::vector_type::weight: return "weight";
    case tiny_ynn::vector_type::bias: return "bias";
    case tiny_ynn::vector_type::label: return "label";
    case tiny_ynn::vector_type::aux: return "aux";
