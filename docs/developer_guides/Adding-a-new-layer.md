# Adding a new layer
This section describes how to create a new layer incorporated with tiny-ynn. Let's create simple fully-connected layer for example.

> Note: This document is old, and doesn't fit to current tiny-ynn. We need to update.

### Declare class
Let's define your layer. All of layer operations in tiny-ynn are derived from ```layer``` class.
...
Congratulations! Now you can use this new class as a tiny-ynn layer.
