tiny-ynn documentations
########################

`tiny-ynn <https://github.com/tiny-ynn/tiny-ynn/>`_ is a header only,
...
* `MNIST image classification <https://github.com/tiny-ynn/tiny-ynn/tree/master/examples/mnist>`_
* `Cifar-10 image classification <https://github.com/tiny-ynn/tiny-ynn/tree/master/examples/cifar10>`_
* `Deconvolutional Auto-encoder <https://github.com/tiny-ynn/tiny-ynn/tree/master/examples/deconv>`_
* `Importing Caffe's model into tiny-ynn <https://github.com/tiny-ynn/tiny-ynn/tree/master/examples/caffe_converter>`_
...
External Links
********************
Here is the list of apps/papers using tiny-ynn. I'm willing to update this list if your software use tiny-ynn. Please contact me at nyanpn (at) gmail (dot) com.
...
* `edgarriba/opencv_contrib <https://github.com/edgarriba/opencv_contrib>`_ (in progress) - A new opencv's dnn module which use tiny-ynn as its backend
