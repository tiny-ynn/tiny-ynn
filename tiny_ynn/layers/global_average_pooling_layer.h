...
#include "tiny_ynn/core/kernels/global_avepool_grad_op.h"
#include "tiny_ynn/core/kernels/global_avepool_op.h"
...
#ifndef CNN_USE_AVX
      nn_warn(
        "tiny-ynn has not been compiled with AVX support, "
