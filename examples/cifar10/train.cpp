...
void construct_net(N &nn, tiny_ynn::core::backend_t backend_type) {
  ...
  nn << conv(32, 32, 5, 3, n_fmaps, tiny_ynn::padding::same, true, 1, 1, 1, 1,
             backend_type)                      // C1
     << pool(32, 32, n_fmaps, 2, false, backend_type)  // P2
     << relu()                                  // activation
     << conv(16, 16, 5, n_fmaps, n_fmaps, tiny_ynn::padding::same, true, 1, 1,
             1, 1,
             backend_type)                      // C3
     << pool(16, 16, n_fmaps, 2, false, backend_type)  // P4
     << relu()                                  // activation
     << conv(8, 8, 5, n_fmaps, n_fmaps2, tiny_ynn::padding::same, true, 1, 1, 1,
             1,
             backend_type)                                // C5
...
void train_cifar10(std::string data_dir_path,
  ...
  // training
  nn.train<tiny_ynn::cross_entropy>(optimizer, train_images, train_labels,
