**tiny-ynn** is a C++14 implementation of deep learning. It is suitable for deep learning on limited computational resource, embedded systems and IoT devices.
**tiny-ynn** is a fork of tiny-dnn with a goal to use OpenCL computing and continue develop of tiny-dnn

| **`Linux/Mac OS`** | **`Windows`** |
|------------------|-------------|
|[![Build Status](https://travis-ci.org/tiny-ynn/tiny-ynn.svg?branch=master)](https://travis-ci.org/tiny-ynn/tiny-ynn)|[![Build status](https://ci.appveyor.com/api/projects/status/a5syoifm8ct7b4l2?svg=true)](https://ci.appveyor.com/project/tinyynn/tiny-ynn)|
...
Check out the [documentation](http://tiny-ynn.readthedocs.io/) for more info.

## What's New
- 2016/11/30 [v1.0.0a3 is released!](https://github.com/tiny-ynn/tiny-ynn/tree/v1.0.0a3)
- 2016/9/14 [tiny-ynn v1.0.0alpha is released!](https://github.com/tiny-ynn/tiny-ynn/releases/tag/v1.0.0a)
- 2016/8/7  tiny-ynn is now moved to organization account, and renamed into tiny-ynn :)
- 2016/7/27 [tiny-ynn v0.1.1 released!](https://github.com/tiny-ynn/tiny-ynn/releases/tag/v0.1.1)
...
- Portable & header-only:
    ...
    - Just include tiny_ynn.h and write your model in C++. There is nothing to install.
- Easy to integrate with real applications:
    - No output to stdout/stderr.
    - A constant throughput (simple parallelization model, no garbage collection).
    - Works without throwing an exception.
    - [Can import caffe's model](https://github.com/tiny-ynn/tiny-ynn/tree/master/examples/caffe_converter).
- Simply implemented:
    - A good library for learning neural networks.

## Comparison with other libraries

Please see [wiki page](https://github.com/tiny-ynn/tiny-ynn/wiki/Comparison-with-other-libraries).

## Supported networks
### layer-types
- core
    - fully connected
    - shared fully connected (new)
    - dropout
    - linear operation
    - zero padding
    - power
...
## Build
tiny-ynn is header-only, so *there's nothing to build*. If you want to execute sample program or unit tests, you need to install [cmake](https://cmake.org/) and type the following commands:
...
|USE_AVX2|Build tiny-ynn with AVX2 library support|OFF|Intel CPU which supports AVX2|
...
<sup>1</sup> tiny-ynn use C++14 standard library for parallelization by default.

<sup>2</sup> If you don't use serialization, you can switch off to speedup compilation time.

<sup>3</sup> tiny-ynn uses [Google Test](https://github.com/google/googletest) as default framework to run unit tests. No pre-installation required, it's  automatically downloaded during CMake configuration.
...
For more samples, read examples/main.cpp or [MNIST example](https://github.com/tiny-ynn/tiny-ynn/tree/master/examples/mnist) page.

## Contributing
Since deep learning community is rapidly growing, we'd love to get contributions from you to accelerate tiny-ynn development!
...
<tr>
    ...
    <td> https://gitter.im/tiny-ynn/developers </td>
</tr>
<tr>
    <td><b> users </b></td>
    <td> https://gitter.im/tiny-ynn/users </td>
</tr>
</table>
