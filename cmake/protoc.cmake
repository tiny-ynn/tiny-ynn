...
if(PROTOBUF_FOUND)
    set(proto_file "${CMAKE_SOURCE_DIR}/tiny_ynn/io/caffe/caffe.pb.cc")
...
# and should be installed separately as in: sudo apt-get install protobuf-compiler
    elseif(EXISTS ${PROTOBUF_PROTOC_EXECUTABLE})
        ...
        if(EXISTS ${CMAKE_SOURCE_DIR}/tiny_ynn/io/caffe/caffe.proto)
            # Note that this line doesn't invoke protoc at configure time
            PROTOBUF_GENERATE_CPP(PROTO_SRCS PROTO_HDRS
                ${CMAKE_SOURCE_DIR}/tiny_ynn/io/caffe/caffe.proto)
            ...
            add_custom_command(TARGET generated_proto PRE_BUILD
                               ...
                               ${PROTO_SRCS} ${CMAKE_SOURCE_DIR}/tiny_ynn/io/caffe)
            add_custom_command(TARGET generated_proto PRE_BUILD
                               COMMAND ${CMAKE_COMMAND} -E copy
                               ${PROTO_HDRS} ${CMAKE_SOURCE_DIR}/tiny_ynn/io/caffe)
